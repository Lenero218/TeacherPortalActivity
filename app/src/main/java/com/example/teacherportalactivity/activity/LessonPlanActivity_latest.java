...
public class LessonPlanActivity_latest extends AppCompatActivity implements InternetRetryListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new CommonUtils(LessonPlanActivity_latest.this).screenCaptureFLAGSECURE();
        setContentView(R.layout.activity_lessonid);
                    ...
                    call.enqueue(new Callback<Token>() {
                        ...
                        public void onResponse(Call<Token> call, retrofit2.Response<Token> response) {
                            ...
                            if (response.body().getError().equals(false) && response.body().getCode().equals(200)) {
                                ...
                                planDetails = response.body().getData().getPlanDetails();
                                lessonPlanAdapter = new LessonPlanAdapter((List<PlanDetail>) planDetails, LessonPlanActivity_latest.this, ints.getStringExtra("lesson_id"));
                                recyclerView.setAdapter(lessonPlanAdapter);
                            } else {
                                ShowDialog.showInternetAlert(LessonPlanActivity_latest.this, "No Data Found");
                            }
                        }
                        ...
                        public void onFailure(Call<Token> call, Throwable t) {
                            ...
                            ShowDialog.showInternetAlert(LessonPlanActivity_latest.this, t.toString());
                        }
                    });
                } catch (Exception ex) {
                    progressDialog.dismiss();
