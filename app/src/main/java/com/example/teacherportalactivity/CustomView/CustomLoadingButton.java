...
public class CustomLoadingButton extends View {
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        if(attrs != null){
            ...
            TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.CustomLoadingButton, 0, 0);
            mColorPrimary = ta.getInt(R.styleable.CustomLoadingButton_btnColor,defaultColor);
            String text = ta.getString(R.styleable.CustomLoadingButton_btnText);
            mText = text == null ? "" : text;
            mTextColor = ta.getColor(R.styleable.CustomLoadingButton_textColor,ContextCompat.getColor(context, R.color.colorPrimaryDark));
            resetAfterFailed = ta.getBoolean(R.styleable.CustomLoadingButton_resetAfterFailed,true);
            mRippleColor = ta.getColor(R.styleable.CustomLoadingButton_btnRippleColor, Color.WHITE);
            mRippleAlpha = ta.getFloat(R.styleable.CustomLoadingButton_btnRippleAlpha,0.3f);
            ta.recycle();
        }
        ...
        mTextPaint.setTypeface(Typeface.create(getResources().getString(R.string.Noto_Serif), Typeface.NORMAL));// include type face
